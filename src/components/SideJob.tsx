...
const contents = [
    {
        ...
        content:
            "Next.js+LaravelでのWebアプリケーション開発を行なっています。機能開発だけでなく既存テストコードのカバレッジ改善、DXや脆弱性など非機能面での改善のお手伝いもしています。またNest.js×LangChainを利用したマイクロサービスの全体的な技術選定・構築・実装までも担当しています。",
    },
];
                    ...
                    <div className="px-8 mt-4">
                        <ul className="list-disc text-sm font-normal text-gray-400">
                            <li>
                                ...
                                Kotlin(Ktor) or React(Next.js)案件
                            </li>
                            <li>
