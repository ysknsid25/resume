    ...
    return (
        <div className="flex justify-center items-center md:h-32 md:w-32 h-24 w-24 rounded-xl bg-white border-solid border-2 border-gray-200">
            <div className={
                ...
                <img className="inline-block md:h-12 md:w-12 h-10 w-10 transform -rotate-45" src={skill.icon} alt="icon" />
            </div>
        </div>
    )
}
    ...
    return (
        <div className="grid grid-cols-1 items-center justify-center gap-4">
            <div className="flex justify-center items-center gap-4 mb-4">
                <h1 className="text-center text-3xl font-extrabold text-gray-600 underline">Skills</h1>
            </div>
